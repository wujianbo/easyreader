...
public abstract class ZLAndroidApplication extends Application {
	...
	public void onCreate() {
        FBReaderIntents.defaultPackage = getPackageName();
		super.onCreate();
		...
		config.runOnConnect(new Runnable() {
			public void run() {
                File mainBookDirectory = new File(Paths.mainBookDirectory());
                if (!mainBookDirectory.exists()) {
                    mainBookDirectory.mkdir();
                }
