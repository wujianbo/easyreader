...
public class BugReportActivity extends Activity implements ErrorKeys {
	public void onCreate(Bundle icicle) {
		...
		reportTextView.append(getApplicationName(this) + " " + versionName + " has been crached, sorry. You can help to fix this bug by sending the report below to " + getApplicationName(this) + " developers. The report will be sent by e-mail. Thank you in advance!\n\n");
		...
		findViewById(R.id.send_report).setOnClickListener(
			new View.OnClickListener() {
				public void onClick(View view) {
					...
					sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "easyreader.exception@gmail.com" });
					sendIntent.putExtra(Intent.EXTRA_TEXT, reportText.toString());
					sendIntent.putExtra(Intent.EXTRA_SUBJECT, getApplicationName(BugReportActivity.this) + " " + versionName + " exception report");
